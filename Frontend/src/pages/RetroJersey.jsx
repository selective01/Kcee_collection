...
const RetroJersey = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/products/category/RetroJersey`)
      .then((res) => res.json())
  ...
  return (
    <>
      <SEO
        title="Retro Jerseys"
        description="Shop Premium Retro Jerseys at Kcee Collection."
        image="https://kceecollection.com/og-image.jpg"
        url="https://kceecollection.com/retro-jersey"
      />
      <section className="premium-categories product-page">
        <div className="section-header">
          <h2>Retro Jerseys</h2>
          <p>Premium Retro Jerseys</p>
        </div>
