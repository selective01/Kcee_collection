...
const Sleeveless = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/products/category/Sleeveless`)
      .then((res) => res.json())
  ...
  return (
    <>
      <SEO
        title="Sleeveless"
        description="Shop Luxury Sleeveless Tops at Kcee Collection."
        image="https://kceecollection.com/og-image.jpg"
        url="https://kceecollection.com/sleeveless"
      />
      <section className="premium-categories product-page">
        <div className="section-header">
          <h2>Sleeveless</h2>
          <p>Luxury Sleeveless Tops</p>
        </div>
