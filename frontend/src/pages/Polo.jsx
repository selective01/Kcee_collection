...
const Polo = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/products/category/Polo`)
      .then((res) => res.json())
  ...
  return (
    <>
      <SEO
        title="Polo"
        description="Shop Premium Polo Shirts at Kcee Collection."
        image="https://kceecollection.com/og-image.jpg"
        url="https://kceecollection.com/polo"
      />
      <section className="premium-categories product-page">
        <div className="section-header">
          <h2>Polo</h2>
          <p>Premium Polo Shirts</p>
        </div>
