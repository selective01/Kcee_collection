...
const ClubJersey = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/products/category/ClubJersey`)
      .then((res) => res.json())
  ...
  return (
    <>
      <SEO
        title="Club Jerseys"
        description="Shop Premium Club Jerseys at Kcee Collection."
        image="https://kceecollection.com/og-image.jpg"
        url="https://kceecollection.com/club-jersey"
      />
      <section className="premium-categories product-page">
        <div className="section-header">
          <h2>Club Jerseys</h2>
          <p>Premium Club Jerseys</p>
        </div>
